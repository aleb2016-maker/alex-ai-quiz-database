...
ENGINE = ROOT / "mini_llm/python/runtime/mini_llm_universal_orchestrator_v4004.py"

OUT_DIR = ROOT / "reports/mini_llm_v4004"
...
def write_markdown(results):
    lines = []
    lines.append("# Mini LLM V400.4 - Produzione multi-documento")
    lines.append("")
    ...
    (OUT_DIR / "production_suite_v4004.md").write_text("\n".join(lines), encoding="utf-8")
...
def write_portfolio(results):
    ...
    (OUT_DIR / "portfolio_output_v4004.md").write_text("\n".join(lines), encoding="utf-8")
...
def main():
    ...
    summary_json = OUT_DIR / "production_suite_v4004.json"
    ...
    print(f"MD: {OUT_DIR / 'production_suite_v4004.md'}")
    print(f"PORTFOLIO: {OUT_DIR / 'portfolio_output_v4004.md'}")
