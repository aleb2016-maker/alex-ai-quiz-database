...
ENGINE = ROOT / "mini_llm/python/runtime/mini_llm_universal_orchestrator_v4005.py"

OUT_DIR = ROOT / "reports/mini_llm_v4005"
...
def write_markdown(results):
    lines = []
    lines.append("# Mini LLM V400.5 - Produzione multi-documento")
    lines.append("")
    ...
    (OUT_DIR / "production_suite_v4005.md").write_text("\n".join(lines), encoding="utf-8")


def write_portfolio(results):
    lines = []
    lines.append("# Mini LLM V400.5 - Portfolio output generati")
    lines.append("")
    ...
    (OUT_DIR / "portfolio_output_v4005.md").write_text("\n".join(lines), encoding="utf-8")
...
def main():
    ...
    summary_json = OUT_DIR / "production_suite_v4005.json"
    ...
    print(f"MD: {OUT_DIR / 'production_suite_v4005.md'}")
    print(f"PORTFOLIO: {OUT_DIR / 'portfolio_output_v4005.md'}")
