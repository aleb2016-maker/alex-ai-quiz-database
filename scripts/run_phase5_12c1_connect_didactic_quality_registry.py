...
"""
FASE 5.12C.1 — CONNECT DIDACTIC QUALITY REGISTRY

Collega i 10 motori qualità didattica 5.12C al registry dei 23 motori pronti.
Output atteso:
- 23 motori già pronti e collegati
- 10 motori didattici collegati
- totale 33 motori pronti e collegati
"""
...
from backend.phase5_quality_registry_bridge_v512c1 import (  # noqa: E402
    READY_LABEL,
...
OUT_JSON = REPORTS_DIR / "phase5_12c1_quality_registry_33_connected_v1.json"
OUT_MD = REPORTS_DIR / "phase5_12c1_quality_registry_33_connected_v1.md"
...
def write_reports(report: Dict[str, Any]) -> None:
    ...
    lines: List[str] = []
    lines.append("# Fase 5.12C.1 — Registry 33 motori collegati")
    lines.append("")
    ...
    lines.append(f"- Nuovi motori qualità didattica collegati: `{report['new_didactic_quality_motors']}`")
    ...
    lines.append("")
    lines.append(
        "Questa fase collega i motori didattici 5.12C al registry pronto. "
        "Non altera i 23 motori precedenti, non modifica la pipeline 5.11 "
        "e non tocca UI/PDF/CSS/app. Il totale ufficiale diventa 33 motori pronti e collegati."
    )
    lines.append("")
...
def main() -> int:
    ...
    if report["approved"]:
        ...
        print(f"Motori didattici collegati: {report['new_didactic_quality_motors']}")
