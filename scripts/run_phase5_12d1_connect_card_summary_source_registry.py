...
"""
FASE 5.12D.1 — CONNECT CARD/SUMMARY/SOURCE QUALITY REGISTRY

Collega i 10 motori Card/Riassunto/Fonti 5.12D al registry dei 33 motori pronti.
Output atteso:
- 33 motori già pronti e collegati
- 10 motori Card/Riassunto/Fonti collegati
- totale 43 motori pronti e collegati
"""
...
from backend.phase5_quality_registry_bridge_v512d1 import (  # noqa: E402
    READY_LABEL,
...
OUT_JSON = REPORTS_DIR / "phase5_12d1_quality_registry_43_connected_v1.json"
OUT_MD = REPORTS_DIR / "phase5_12d1_quality_registry_43_connected_v1.md"
...
def write_reports(report: Dict[str, Any]) -> None:
    ...
    lines: List[str] = []
    lines.append("# Fase 5.12D.1 — Registry 43 motori collegati")
    lines.append("")
    ...
    lines.append(f"- Nuovi motori Card/Riassunto/Fonti collegati: `{report['new_card_summary_source_motors']}`")
    ...
    lines.append("")
    lines.append(
        "Questa fase collega i motori Card/Riassunto/Fonti 5.12D al registry pronto. "
        "Non altera i 33 motori precedenti, non modifica la pipeline 5.11 e non tocca UI/PDF/CSS/app. "
        "Il totale ufficiale diventa 43 motori pronti e collegati."
    )
    lines.append("")
...
def main() -> int:
    ...
    if report["approved"]:
        ...
        print(f"Motori Card/Riassunto/Fonti collegati: {report['new_card_summary_source_motors']}")
