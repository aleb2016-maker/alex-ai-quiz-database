...
from backend.phase5_quality_registry_bridge_v512g1 import (  # noqa: E402
    READY_LABEL,
...
PHASE = "5.12G.1"
OUT_JSON = REPORTS_DIR / "phase5_12g1_quality_registry_65_connected_v1.json"
OUT_MD = REPORTS_DIR / "phase5_12g1_quality_registry_65_connected_v1.md"
...
def write_reports(report: Dict[str, Any]) -> None:
    ...
    lines: List[str] = []
    lines.append("# Fase 5.12G.1 — Registry 65 motori collegati")
    lines.append("")
    ...
    lines.append(f"- Nuovi motori duplicati contestuali collegati: `{report['new_contextual_duplicate_motors']}`")
    ...
    lines.append("")
    lines.append(
        "Questa fase collega i 6 motori duplicati contestuali 5.12G al registry. "
        "Non modifica i 59 motori precedenti, non cambia la pipeline 5.11 e non tocca UI/PDF/CSS/app."
    )
    lines.append("")
...
def main() -> int:
    ...
    if report["approved"]:
        ...
        print(f"Motori duplicati contestuali collegati: {report['new_contextual_duplicate_motors']}")
