...
MARKER = "# FASE 5.3 — LIVE QUALITY BRIDGE V1"
...
def main() -> int:
    ...
    if MARKER in text:
        print("ℹ️ Marker Fase 5.3 già presente: non duplico wrapper.")
    else:
        backup = MOTORI.with_suffix(MOTORI.suffix + ".bak_phase5_live_quality_bridge_v1")
        shutil.copy2(MOTORI, backup)
        ...
        print(f"✅ Wrapper Fase 5.3 aggiunto a: {MOTORI}")
        print(f"Backup creato: {backup}")

    print(f"✅ Bridge creato: {BRIDGE}")
    print(f"✅ Test creato:   {TEST}")
    print("✅ PATCH FASE 5.3 LIVE QUALITY BRIDGE V1 COMPLETATA")
