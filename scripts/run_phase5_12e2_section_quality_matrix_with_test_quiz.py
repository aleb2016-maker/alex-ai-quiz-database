...
from backend.phase5_section_quality_matrix_v512e2 import (  # noqa: E402
    READY_LABEL,
...
PHASE = "5.12E.2"
OUT_JSON = REPORTS_DIR / "phase5_12e2_section_quality_selection_matrix_with_test_quiz_v1.json"
OUT_MD = REPORTS_DIR / "phase5_12e2_section_quality_selection_matrix_with_test_quiz_v1.md"
...
def write_reports(report: Dict[str, Any]) -> None:
    ...
    lines: List[str] = []
    lines.append("# Fase 5.12E.2 — Section Quality Matrix con Test/Quiz")
    lines.append("")
    ...
    lines.append(
        ...
        "I motori specifici Test/Quiz vengono aggiunti solo alla sezione Test/Quiz."
    )
    lines.append("")
...
def main() -> int:
    ...
    print(f"FAIL - Fase {PHASE}: section matrix with test quiz not approved")
