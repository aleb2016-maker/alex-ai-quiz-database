...
DOC = """# RAG Adapter Quiz Ufficiale V4.3
...
REPORT = """# Installazione RAG Adapter Quiz Ufficiale V4.3

Blocco installato.

Questo report verrà aggiornato dal comando:

```bash
python3 scripts/rag_adapter_quiz_ufficiale_v43.py --documento rag/documenti/documento_rag_sicurezza_informatica_aziendale.md --categoria informatica --sottocategoria sicurezza_informatica --numero-domande 6 --output dist/generated/rag_quiz_bridge_v43.json
```
"""
...
def main() -> None:
    ...
    write(root / "scripts" / "rag_adapter_quiz_ufficiale_v43.py", ADAPTER)
    write(root / "scripts" / "verifica_rag_adapter_quiz_ufficiale_v43.py", VERIFIER)
    write(root / "docs" / "RAG_ADAPTER_QUIZ_UFFICIALE_V43.md", DOC)
    write(root / "reports" / "rag_adapter_quiz_ufficiale_v43.md", REPORT)

    print()
    print("✅ RAG Adapter Quiz Ufficiale V4.3 installato")
    print("📌 Prova:")
    print("   python3 scripts/rag_adapter_quiz_ufficiale_v43.py --documento rag/documenti/documento_rag_sicurezza_informatica_aziendale.md --categoria informatica --sottocategoria sicurezza_informatica --numero-domande 6 --output dist/generated/rag_quiz_bridge_v43.json")
    print("🧪 Verifica:")
    print("   python3 scripts/verifica_rag_adapter_quiz_ufficiale_v43.py .")
