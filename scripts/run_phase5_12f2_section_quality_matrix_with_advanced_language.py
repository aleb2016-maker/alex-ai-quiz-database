...
from backend.phase5_section_quality_matrix_v512f2 import (  # noqa: E402
    READY_LABEL,
...
PHASE = "5.12F.2"
OUT_JSON = REPORTS_DIR / "phase5_12f2_section_quality_selection_matrix_with_advanced_language_v1.json"
OUT_MD = REPORTS_DIR / "phase5_12f2_section_quality_selection_matrix_with_advanced_language_v1.md"
...
def write_reports(report: Dict[str, Any]) -> None:
    ...
    lines: List[str] = []
    lines.append("# Fase 5.12F.2 — Section Quality Matrix con motori linguistici avanzati")
    lines.append("")
    ...
    lines.append("")
    lines.append(
        "Questa matrice aggiorna solo la selezione logica dei motori per sezione. "
        "I 4 motori linguistici avanzati vengono aggiunti a tutte le sezioni che producono testo."
    )
    lines.append("")
...
def main() -> int:
    ...
    print(f"FAIL - Fase {PHASE}: section matrix with advanced language not approved")
