# Fisica quantistica — distrattori da migliorare

Domande totali in `data/fisica_quantistica.json`: **40**
Domande da migliorare: **21**

Questo file non modifica il database originale. Serve come base di lavoro per migliorare i distrattori.
...
- Non cambiare il concetto della risposta corretta.
- Inserire almeno un distrattore forte vicino alla risposta corretta.
- Eliminare distrattori troppo assoluti o troppo facili.
- Rendere le opzioni simili per lunghezza e forma.
