# Mini LLM V400.5 - Produzione multi-documento
...
- Tempo: `162` ms
- Output MD: `reports/mini_llm_v4005/ai_generativa.md`
...
- Tempo: `197` ms
- Output MD: `reports/mini_llm_v4005/informatica_sicurezza_rag.md`
...
- Tempo: `1` ms
- Output MD: `reports/mini_llm_v4005/business_v396.md`
...
- Cards: `GENERATED_SHORT` errori `[]` count `1`
- Tempo: `0` ms
- Output MD: `reports/mini_llm_v4005/curriculum_v396.md`
...
- Cards: `GENERATED_SHORT` errori `[]` count `1`
- Tempo: `1` ms
- Output MD: `reports/mini_llm_v4005/informatics_v396.md`
...
- Cards: `GENERATED_SHORT` errori `[]` count `1`
- Tempo: `1` ms
- Output MD: `reports/mini_llm_v4005/science_v396.md`
...
- Cards: `GENERATED_SHORT` errori `[]` count `1`
- Tempo: `1` ms
- Output MD: `reports/mini_llm_v4005/sport_v396.md`
