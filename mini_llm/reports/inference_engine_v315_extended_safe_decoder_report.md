# Inference Engine V3.15 Safe Dynamic Decoder Report

- Engine: `inference_engine_v315_extended_safe_decoder`
- Generation mode: `extended_safe_semantic_decoder_v315`
...
- Status: `OK`
- Score: `50.0`
- Output: `Una password rubata può esporre un account se non viene protetta da controlli aggiuntivi.`
- Source sentence: `La 2FA riduce il rischio che un account venga violato solo perché la password è stata rubata.`
- Notes: `none`
...
- Status: `OK`
- Score: `50.0`
- Output: `Le credenziali rubate possono consentire accessi non autorizzati ad account o sistemi.`
- Source sentence: `Ogni dipendente deve proteggere le credenziali personali e non deve condividere password o codici di accesso.`
- Notes: `none`
...
- Status: `OK`
- Score: `50.0`
- Output: `Un backup offline aiuta a proteggere i dati perché resta separato dal computer o dalla rete principale.`
- Source sentence: `Il backup serve a recuperare informazioni in caso di errore umano, guasto, furto, cancellazione accidentale o attacco ransomware.`
- Notes: `none`
...
- Status: `OK`
- Score: `50.0`
- Output: `Il ripristino dati serve a recuperare informazioni dopo errore umano, guasto o cancellazione accidentale.`
- Source sentence: `Il backup serve a recuperare informazioni in caso di errore umano, guasto, furto, cancellazione accidentale o attacco ransomware.`
- Notes: `none`
...
- Status: `OK`
- Score: `65.0`
- Output: `Un'email sospetta può essere un segnale di phishing e va controllata prima di aprire link o allegati.`
- Source sentence: `La lezione appresa viene collegata a phishing, segnalazione email, simulazioni periodiche e al piano di continuità operativa.`
- Notes: `none`
...
- Status: `OK`
- Score: `70.0`
- Output: `Gli account amministrativi hanno privilegi elevati e devono essere protetti con controlli aggiuntivi.`
- Source sentence: `Una buona regola aziendale è attivare la 2FA almeno su email, strumenti cloud, account amministrativi, sistemi di pagamento.`
- Notes: `none`
...
- Status: `OK`
- Score: `50.0`
- Output: `Il rischio informatico può esporre dati, account o sistemi a minacce digitali.`
- Source sentence: `La 2FA riduce il rischio che un account venga violato solo perché la password è stata rubata.`
- Notes: `none`
...
- Status: `OK`
- Score: `50.0`
- Output: `Il furto di credenziali espone account e sistemi ad accessi non autorizzati.`
- Source sentence: `Ogni dipendente deve proteggere le credenziali personali e non deve condividere password o codici di accesso.`
- Notes: `none`
